...
<!------------ Header ------------>
<header id="Header" class="w-100 text-center pt-lg-4">
	<div class="container">
	<a href="<?php echo get_home_url(); ?>" class="navbar-brand"><img src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/custom/images/logo.png" alt="" class="img-fluid my-3" /></a>
		...
		<div class="d-flex d-md-none border-left align-items-middle me-2">
			...
			<span class="navbar-toggler-iconx"><i class="fa fa-bars text-white fs"></i></span>
			</button>
		</div>           
		<div></div>
			...
			<ul class="navbar-nav text-uppercase fw-medium mx-auto">
